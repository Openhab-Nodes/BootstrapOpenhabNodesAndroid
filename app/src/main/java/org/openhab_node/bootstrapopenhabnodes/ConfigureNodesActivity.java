...
public class ConfigureNodesActivity extends AppCompatActivity implements ServiceConnection, View.OnClickListener, BootstrapService.BootstrapProgressListener, BootstrapDeviceUpdateListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_configure_nodes);
