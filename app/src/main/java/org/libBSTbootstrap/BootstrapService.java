...
public class BootstrapService extends Service {
    ...
    public void addBSData(Map<String,String> bootstrapString) {
        data.bst_additional_bst_data.putAll(bootstrapString);
    }

    public static List<BootstrapDataIntentExtractor> bootstrapDataIntentExtractorList = new ArrayList<>();

    public static void addDataIntentExtractor(BootstrapDataIntentExtractor extractor) {
        bootstrapDataIntentExtractorList.add(extractor);
    }

    public void addBSData(Bundle extra) {
        for (BootstrapDataIntentExtractor extractor: bootstrapDataIntentExtractorList)
            data.bst_additional_bst_data.putAll( extractor.getData(extra));
    }
